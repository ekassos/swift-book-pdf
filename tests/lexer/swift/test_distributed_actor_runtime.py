...
def test_distributed_actor_runtime() -> None:
    source = (_FIXTURES / "distributed-actor-runtime.txt").read_text()
    expected = (_FIXTURES / "distributed-actor-runtime.expect.txt").read_text()
