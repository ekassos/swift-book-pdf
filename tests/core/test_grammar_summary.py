...
from swift_book_pdf.core.generated.summary.config import (
    parse_generate_grammar,
    parse_publish_book,
)
...
""",
    ...
    config = parse_generate_grammar(script_path)
...
""",
    ...
    config = parse_publish_book(script_path)
...
def test_normalize_grammar_summary_text_converts_legacy_rule_paragraphs() -> (
    ...
    normalized = normalize_grammar_summary_text(summary_text)
...
def test_normalize_grammar_summary_text_preserves_current_upstream_layout() -> (
    ...
    assert normalize_grammar_summary_text(summary_text) == summary_text
